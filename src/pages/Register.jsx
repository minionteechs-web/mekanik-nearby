...
function MechanicFields({ formData, handleChange }) {
        ...
        <div className="mechanic-fields">
            ...
            <div className="mechanic-section-header">
                ...
                <div>
                    ...
                    <span>Required to join as a mechanic</span>
...
export function Register() {
    ...
    const handleRegister = async (e) => {
        ...
        if (formData.role === 'mechanic') {
            ...
            if (!formData.workshopName.trim() || !formData.specialty || !formData.city.trim()) {

                setError('Workshop name, specialty, and city are required to join as a mechanic.');
            ...
            <Card className="auth-card">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    {formData.role === 'mechanic' && (
                        ...
                        <MechanicFields formData={formData} handleChange={handleChange} />
